...
import { PRODUCT_UPDATE_REQUEST, PRODUCT_UPDATE_SUCCESS, PRODUCT_UPDATE_FAIL } from "../constants/productConstants";
...
//redux-thunk helps us to call function within function, instead of action object.
...
export const listTopProducts = () => async (dispatch) => {
    try {
        await dispatch({ type: PRODUCT_TOP_REQUEST })
