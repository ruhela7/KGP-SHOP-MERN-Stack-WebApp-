...
import { ORDER_DELIVER_REQUEST, ORDER_DELIVER_SUCCESS, ORDER_DELIVER_FAIL } from "../constants/orderConstants.js"
...
export const createOrder = (order) => async (dispatch, getState) => {
    try {
        ...
        const config = {
            headers: {
                'Content-Type': 'application/json', //post & put requests need to tell content type.
